...
var githubApiKey = exports.githubApiKey = '8c4e9f7b11c0b943d2cca16e60d390f507a2cab6';
...
function controllerRouter() {
  ...
  var userFetch = _jquery2.default.getJSON('http://api.github.com/users/' + currentRoute + '?access_token=' + _secrets.githubApiKey);
  var repoFetch = _jquery2.default.getJSON('http://api.github.com/users/' + currentRoute + '/repos?access_token=' + _secrets.githubApiKey);

  _jquery2.default.when(userFetch, repoFetch).then(function (userData, repoData) {
